...
class EfficientNet(nn.Module):
    def __init__(self, num_classes=15, width_coef=1., depth_coef=1., scale=1., dropout=0.2, se_scale=4, stochastic_depth=False, p=0.5):
        super().__init__()
        ...
        self.stage1 = nn.Sequential(
            nn.Conv2d(in_channel, channels[0],3, stride=2, padding=1, bias=False),
